...
{
    public class GenerationToGridSyncWorker : BackgroundService
    {
        private readonly IServiceProvider _serviceProvider;
        private readonly ILogger<GenerationToGridSyncWorker> _logger;
        private readonly string _remoteApiUrl = "https://localhost:63716/api/sync"; 

        public GenerationToGridSyncWorker(IServiceProvider serviceProvider, ILogger<GenerationToGridSyncWorker> logger)
        {
                    ...
                    if (response != null && response.Any())
                    {
                        ...
                        foreach (var remoteDay in response)
                        {
                            ...
                            if (localDay == null)
                            {
                                ...
                                remoteDay.Id = 0; 
                                foreach (var h in remoteDay.HourDatas) h.Id = 0; 
